...
The **3-AxisDigitalAccelerometer1_5g** library is included in the **Meadow.Foundation.Grove.Sensors.Motion.3-AxisDigitalAccelerometer1_5g** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
