...
The **MiniPIRMotionSensor** library is included in the **Meadow.Foundation.Grove.Sensors.Motion.MiniPIRMotionSensor** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
