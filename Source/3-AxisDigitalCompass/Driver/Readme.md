...
The **3-AxisDigitalCompass** library is included in the **Meadow.Foundation.Grove.Sensors.Motion.3-AxisDigitalCompass** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
