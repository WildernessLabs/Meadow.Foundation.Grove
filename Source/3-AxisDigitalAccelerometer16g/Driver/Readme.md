...
The **3-AxisDigitalAccelerometer_16g** library is included in the **Meadow.Foundation.Grove.Sensors.Motion.3-AxisDigitalAccelerometer_16g** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Grove.Sensors.Motion.3-AxisDigitalAccelerometer_16g`
## Usage
