...
The **VibrationMotor** library is included in the **Meadow.Foundation.Grove.HID.VibrationMotor** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Grove.HID.VibrationMotor`
## Usage
