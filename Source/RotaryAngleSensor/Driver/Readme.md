...
The **RotaryAngleSensor** library is included in the **Meadow.Foundation.Grove.Sensors.Rotary.RotaryAngleSensor** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
