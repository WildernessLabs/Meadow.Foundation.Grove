# Meadow.Foundation.Grove.Sensors.Rotary.RotaryAngleSensor

**Grove rotary angle sensor**

The **RotaryAngleSensor** library is included in the **Meadow.Foundation.Grove.Sensors.Rotary.RotaryAngleSensor** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Grove.Sensors.Rotary.RotaryAngleSensor`
## Usage
