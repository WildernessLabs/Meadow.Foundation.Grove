...
The **MagneticSwitch** library is included in the **Meadow.Foundation.Grove.Sensors.Switches.MagneticSwitch** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
