...
The **Buzzer** library is included in the **Meadow.Foundation.Grove.Audio.Buzzer** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
