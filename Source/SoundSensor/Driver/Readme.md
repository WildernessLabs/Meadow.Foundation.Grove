...
The **SoundSensor** library is included in the **Meadow.Foundation.Grove.Sensors.Sound.SoundSensor** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
