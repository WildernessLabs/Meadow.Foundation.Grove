...
The **MoistureSensor** library is included in the **Meadow.Foundation.Grove.Sensors.Moisture.MoistureSensor** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
