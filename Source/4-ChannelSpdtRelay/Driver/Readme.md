...
The **4-ChannelSpdtRelay** library is included in the **Meadow.Foundation.Grove.Relays.4-ChannelSpdtRelay** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
