...
The **LineFinder** library is included in the **Meadow.Foundation.Grove.Sensors.Light.LineFinder** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
