...
The **VibrationSensor** library is included in the **Meadow.Foundation.Grove.Sensors.Motion.VibrationSensor** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
